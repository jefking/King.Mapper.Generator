namespace King.Mapper.Generator.Unit
{
    ...
    public class CodeGeneratorTests
    {
        ...
        public void ConstructorLoaderNull()
        {
            ...
            Assert.Throws<ArgumentNullException>(() => new CodeGenerator(null, factory, writer));
        }
        ...
        public void ConstructorFactoryNull()
        {
            ...
            Assert.Throws<ArgumentNullException>(() => new CodeGenerator(loader, null, writer));
        }
        ...
        public void ConstructorWriterNull()
        {
            ...
            Assert.Throws<ArgumentNullException>(() => new CodeGenerator(loader, factory, null));
        }
